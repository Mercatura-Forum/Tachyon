/// run_tests_icrc7.mo - interpreter battery for the NFT (`#icrc7`) leg predicates.
///
...
let MAKER = Principal.fromText("rsrwg-uo6vu-aqcai-baeaq-caiba-eaqca-ibaea-qcaib-aeaqc-aibae-aqe");
